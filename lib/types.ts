...
export interface UserProfile {
  ...
  /** Optional free-text coaching notes from signup/onboarding to personalize the plan. */
  specificGoals?: string;
  /** Explicit focus areas the athlete wants the coach to prioritize. */
  focusAreas?: string[];
  /** A concise, Groq-generated summary of the athlete's goals and coaching priorities. */
